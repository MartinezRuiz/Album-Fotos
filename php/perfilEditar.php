...
<div  class="container pt-4" style=" padding: auto">
    ...
    <div class="form-group">
      ...
      <input type="password"  class="form-control" name="password" placeholder="Contraseña" pattern="[A-Za-z0-9!?-]{8,12}" title="La contraseña debe tener minimo 8 y máximo 12 caracteres" required>
    </div>
