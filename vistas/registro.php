 ...
 <div class="formulario_reg" >
    ...
    <form action="../php/r.php" method="POST" enctype="multipart/form-data"  class="validated">
     <div class="botones">
              ...
              <br><br>
              <input type="file" name="imagen" id="seleccionArchivos" title="Elige una imagen para tu perfil" required>
    ...
    <table  width="80%" >
      ...
      <tr>
        ...
        <td><input type="text"  class="form-control" name="ape_p" placeholder="Apellido Paterno"  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,64}" title="Ingresa tu primer apellido" required></td>
       </tr>
       <tr>
        <td><label for="">Apellido Materno:</label></td>
        <td><input type="text"  class="form-control" name="ape_m" placeholder="Apellido Materno"  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,64}" title="Ingresa tu segundo apellido" required></td>
        
       </tr>
       <tr>
      <td><label for="">Ingresa tu nombre:</label></td>
      <td><input type="text" class="form-control  " name="nombre" placeholder="Nombre(s)" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" title="Ingresa tu(s) nombre(s)" required>   </td>
       </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="password"  class="form-control" name="password" placeholder="Contraseña" pattern="[A-Za-z0-9!?-]{8,12}" title="La contraseña debe tener entre 8 y 12 caracteres, letras minusculas, mayúsculas o números"  required></td>
      </tr>
